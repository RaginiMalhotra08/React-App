    ...
    return (
      <div className="container">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="password">AddressLine1</label>
            <input
          ...
          <div className="form-group">
            <label htmlFor="password">AddressLine2</label>
            <input
          ...
          <div className="form-group">
            <label htmlFor="password">CreatedBy</label>
            <input
          ...
          <div className="form-group">
            <label htmlFor="password">ServiceStartDate</label>
            <input
          ...
          <div className="form-group">
            <label htmlFor="password">ServiceEndDate</label>
            <input
